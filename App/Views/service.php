				...
				<div class="page">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="feature">
									<img src="<?= assets('images/icon-5.png') ?>" class="feature-image">
									<h3 class="feature-title">Voluptatem</h3>
							...
							<div class="col-md-3">
								<div class="feature">
									<img src="<?= assets('images/icon-6.png') ?>" class="feature-image">
									<h3 class="feature-title">COnsequatur</h3>
							...
							<div class="col-md-3">
								<div class="feature">
									<img src="<?= assets('images/icon-7.png') ?>" class="feature-image">
									<h3 class="feature-title">Temporibus</h3>
							...
							<div class="col-md-3">
								<div class="feature">
									<img src="<?= assets('images/icon-8.png') ?>" class="feature-image">
									<h3 class="feature-title">Perferendis</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, facere numquam porro </p>
								</div>
							</div>
